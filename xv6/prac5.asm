...
int main(){
  ...
  18:	75 14                	jne    2e <main+0x2e>
		write(1, "hello", 6);
  1a:	52                   	push   %edx
  1b:	6a 06                	push   $0x6
  1d:	68 10 07 00 00       	push   $0x710
  22:	6a 01                	push   $0x1
  24:	e8 89 02 00 00       	call   2b2 <write>
		exit();
  29:	e8 64 02 00 00       	call   292 <exit>
	}
	else{
		wait();
  2e:	e8 67 02 00 00       	call   29a <wait>
		write(1,"world\n",6);
  33:	50                   	push   %eax
  34:	6a 06                	push   $0x6
  36:	68 16 07 00 00       	push   $0x716
  3b:	6a 01                	push   $0x1
  3d:	e8 70 02 00 00       	call   2b2 <write>
	}
	exit();
