...
int main(){
  ...
  12:	6a 01                	push   $0x1
  14:	e8 f1 02 00 00       	call   30a <dup>
	write(1,"hello",6);
  19:	83 c4 0c             	add    $0xc,%esp
#include "types.h"
#include "user.h"
...
int main(){
  ...
  1c:	89 c3                	mov    %eax,%ebx
	write(1,"hello",6);
  1e:	6a 06                	push   $0x6
  20:	68 10 07 00 00       	push   $0x710
  25:	6a 01                	push   $0x1
  27:	e8 86 02 00 00       	call   2b2 <write>
	write(fd,"world\n",6);
  2c:	83 c4 0c             	add    $0xc,%esp
  2f:	6a 06                	push   $0x6
  31:	68 16 07 00 00       	push   $0x716
  36:	53                   	push   %ebx
  37:	e8 76 02 00 00       	call   2b2 <write>
	exit();
