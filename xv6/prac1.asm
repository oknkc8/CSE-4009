...
int main(int argc, char *argv[]){
  ...
  1b:	51                   	push   %ecx
  1c:	50                   	push   %eax
  1d:	68 30 07 00 00       	push   $0x730
  22:	6a 01                	push   $0x1
  24:	e8 e7 03 00 00       	call   410 <printf>
		pid = wait();
  29:	e8 8c 02 00 00       	call   2ba <wait>
  ...
  46:	75 13                	jne    5b <main+0x5b>
		printf(1,"child exiting\n");
  48:	52                   	push   %edx
  49:	52                   	push   %edx
  4a:	68 54 07 00 00       	push   $0x754
  4f:	6a 01                	push   $0x1
  51:	e8 ba 03 00 00       	call   410 <printf>
		exit();
  56:	e8 57 02 00 00       	call   2b2 <exit>
	}
	else{
		printf(1,"fork error\n");
  5b:	50                   	push   %eax
  5c:	50                   	push   %eax
  5d:	68 63 07 00 00       	push   $0x763
  62:	6a 01                	push   $0x1
  64:	e8 a7 03 00 00       	call   410 <printf>
  69:	83 c4 10             	add    $0x10,%esp
  6c:	eb d3                	jmp    41 <main+0x41>
  6e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 78 07 00 00 	movzbl 0x778(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 6f 07 00 00       	mov    $0x76f,%eax
