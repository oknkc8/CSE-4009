...
int main(){
  11:	83 ec 1c             	sub    $0x1c,%esp
	char *argv[3];
	argv[0]="echo";
  14:	c7 45 ec 18 07 00 00 	movl   $0x718,-0x14(%ebp)
	argv[1]="hello";
  1b:	c7 45 f0 10 07 00 00 	movl   $0x710,-0x10(%ebp)
	argv[2]=0;

	exec("./echo", argv);
  22:	50                   	push   %eax
  23:	68 16 07 00 00       	push   $0x716
...
int main(){
  ...
  28:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	...
	exec("./echo", argv);
  2f:	e8 96 02 00 00       	call   2ca <exec>

	printf(1,"exec error\n");
  34:	58                   	pop    %eax
  35:	5a                   	pop    %edx
  36:	68 1d 07 00 00       	push   $0x71d
  3b:	6a 01                	push   $0x1
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 29 07 00 00       	mov    $0x729,%eax
