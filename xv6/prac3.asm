...
int main(int argc, char *argv[]){
   ...
   e:	53                   	push   %ebx
   f:	51                   	push   %ecx
  10:	8d b5 e8 fd ff ff    	lea    -0x218(%ebp),%esi
  16:	81 ec 0c 02 00 00    	sub    $0x20c,%esp
  1c:	eb 17                	jmp    35 <main+0x35>
  1e:	66 90                	xchg   %ax,%ax
	int n;
	for(;;){
  ...
  26:	56                   	push   %esi
  27:	6a 01                	push   $0x1
  29:	e8 c4 02 00 00       	call   2f2 <write>
  2e:	83 c4 10             	add    $0x10,%esp
  31:	39 c3                	cmp    %eax,%ebx
  33:	75 41                	jne    76 <main+0x76>
...
int main(int argc, char *argv[]){
  ...
  5e:	e8 6f 02 00 00       	call   2d2 <exit>
		if(n<0){
			printf(2,"read error!\n");
  63:	52                   	push   %edx
  64:	52                   	push   %edx
  ...
  6c:	e8 bf 03 00 00       	call   430 <printf>
			exit();
  71:	e8 5c 02 00 00       	call   2d2 <exit>
		}
		if(write(1,buf,n)!=n){
			printf(2,"write error!\n");
  76:	50                   	push   %eax
  77:	50                   	push   %eax
  78:	68 60 07 00 00       	push   $0x760
  7d:	6a 02                	push   $0x2
  7f:	e8 ac 03 00 00       	call   430 <printf>
			exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 78 07 00 00 	movzbl 0x778(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 6e 07 00 00       	mov    $0x76e,%eax
...
malloc(uint nbytes)
{
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 70f:	89 15 18 0a 00 00    	mov    %edx,0xa18
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 18 0a 00 00 1c 	movl   $0xa1c,0xa18
 72d:	0a 00 00 
 730:	c7 05 1c 0a 00 00 1c 	movl   $0xa1c,0xa1c
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 1c 0a 00 00       	mov    $0xa1c,%eax
 73f:	c7 05 20 0a 00 00 00 	movl   $0x0,0xa20
 746:	00 00 00 
