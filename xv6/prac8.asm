...
int main (int argc, char *argv[]) { 
  ...
  16:	e8 df 02 00 00       	call   2fa <mkdir>
	int fd = open("./dir/file", O_CREATE|O_WRONLY); 
  1b:	58                   	pop    %eax
  1c:	5a                   	pop    %edx
  1d:	68 01 02 00 00       	push   $0x201
  22:	68 16 07 00 00       	push   $0x716
  27:	e8 a6 02 00 00       	call   2d2 <open>
	close(fd);
  2c:	89 04 24             	mov    %eax,(%esp)
  2f:	e8 86 02 00 00       	call   2ba <close>

	mknod("/console",1,1); 
  34:	83 c4 0c             	add    $0xc,%esp
  37:	6a 01                	push   $0x1
  39:	6a 01                	push   $0x1
  3b:	68 21 07 00 00       	push   $0x721
  40:	e8 95 02 00 00       	call   2da <mknod>
	exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 34 07 00 00 	movzbl 0x734(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 2a 07 00 00       	mov    $0x72a,%eax
...
free(void *ap)
{
 ...
 591:	a1 cc 09 00 00       	mov    0x9cc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 cc 09 00 00       	mov    %eax,0x9cc
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 cc 09 00 00       	mov    %eax,0x9cc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 cc 09 00 00    	mov    0x9cc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 67f:	76 3f                	jbe    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	39 05 cc 09 00 00    	cmp    %eax,0x9cc
 ...
 6a6:	e8 e5 fe ff ff       	call   590 <free>
  return freep;
 6ab:	8b 15 cc 09 00 00    	mov    0x9cc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6cf:	89 15 cc 09 00 00    	mov    %edx,0x9cc
      return (void*)(p + 1);
 ...
 6e4:	eb e9                	jmp    6cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6e6:	c7 05 cc 09 00 00 d0 	movl   $0x9d0,0x9cc
 6ed:	09 00 00 
 6f0:	c7 05 d0 09 00 00 d0 	movl   $0x9d0,0x9d0
 6f7:	09 00 00 
    base.s.size = 0;
 6fa:	b8 d0 09 00 00       	mov    $0x9d0,%eax
 6ff:	c7 05 d4 09 00 00 00 	movl   $0x0,0x9d4
 706:	00 00 00 
