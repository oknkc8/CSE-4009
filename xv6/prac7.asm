...
int main(){
  11:	83 ec 20             	sub    $0x20,%esp
	...
	char *argv[2];
	argv[0]="wc";
  14:	c7 45 f0 72 07 00 00 	movl   $0x772,-0x10(%ebp)
	argv[1]=0;
  1b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	pipe(p);
  22:	50                   	push   %eax
  23:	e8 da 02 00 00       	call   302 <pipe>
	if(!fork()){
  28:	e8 bd 02 00 00       	call   2ea <fork>
  2d:	83 c4 10             	add    $0x10,%esp
  30:	85 c0                	test   %eax,%eax
  32:	75 3d                	jne    71 <main+0x71>
		close(0);
  34:	83 ec 0c             	sub    $0xc,%esp
  37:	6a 00                	push   $0x0
  39:	e8 dc 02 00 00       	call   31a <close>
		dup(p[0]);
  3e:	5a                   	pop    %edx
  3f:	ff 75 e8             	pushl  -0x18(%ebp)
  42:	e8 23 03 00 00       	call   36a <dup>
		close(p[0]);
  47:	59                   	pop    %ecx
  48:	ff 75 e8             	pushl  -0x18(%ebp)
  4b:	e8 ca 02 00 00       	call   31a <close>
		close(p[1]);
  50:	58                   	pop    %eax
  51:	ff 75 ec             	pushl  -0x14(%ebp)
  54:	e8 c1 02 00 00       	call   31a <close>
		exec("./wc",argv);
  59:	58                   	pop    %eax
  5a:	8d 45 f0             	lea    -0x10(%ebp),%eax
  5d:	5a                   	pop    %edx
  5e:	50                   	push   %eax
  5f:	68 70 07 00 00       	push   $0x770
  64:	e8 c1 02 00 00       	call   32a <exec>
  69:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  6c:	e8 81 02 00 00       	call   2f2 <exit>
		close(p[0]);
		close(p[1]);
		exec("./wc",argv);
	}
  ...
  74:	ff 75 e8             	pushl  -0x18(%ebp)
  77:	e8 9e 02 00 00       	call   31a <close>
		write(p[1], "hello world\n",12);
  7c:	83 c4 0c             	add    $0xc,%esp
  7f:	6a 0c                	push   $0xc
  81:	68 75 07 00 00       	push   $0x775
  86:	ff 75 ec             	pushl  -0x14(%ebp)
  89:	e8 84 02 00 00       	call   312 <write>
		close(p[1]);
  8e:	58                   	pop    %eax
  8f:	ff 75 ec             	pushl  -0x14(%ebp)
  92:	e8 83 02 00 00       	call   31a <close>
		wait();
  97:	e8 5e 02 00 00       	call   2fa <wait>
  9c:	83 c4 10             	add    $0x10,%esp
  9f:	eb cb                	jmp    6c <main+0x6c>
  a1:	66 90                	xchg   %ax,%ax
  a3:	66 90                	xchg   %ax,%ax
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 82 07 00 00       	mov    $0x782,%eax
...
free(void *ap)
{
 ...
 647:	89 08                	mov    %ecx,(%eax)
  freep = p;
 649:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 706:	e8 e5 fe ff ff       	call   5f0 <free>
  return freep;
 70b:	8b 15 24 0a 00 00    	mov    0xa24,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 744:	eb e9                	jmp    72f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 24 0a 00 00 28 	movl   $0xa28,0xa24
 74d:	0a 00 00 
 750:	c7 05 28 0a 00 00 28 	movl   $0xa28,0xa28
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 28 0a 00 00       	mov    $0xa28,%eax
 75f:	c7 05 2c 0a 00 00 00 	movl   $0x0,0xa2c
 766:	00 00 00 
