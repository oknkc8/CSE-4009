...
80101ea8:	68 c6 77 10 80       	push   $0x801077c6
...
80102e22:	e8 69 29 00 00       	call   80105790 <idtinit>
...
80102e95:	e8 66 39 00 00       	call   80106800 <seginit>
  picinit();       // disable pic
...
80102eae:	e8 1d 08 00 00       	call   801036d0 <pinit>
  tvinit();        // trap vectors
80102eb3:	e8 38 28 00 00       	call   801056f0 <tvinit>
  binit();         // buffer cache
...
80103603:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
80103609:	e8 e2 0d 00 00       	call   801043f0 <release>
...
8010362b:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
8010362e:	c7 40 14 df 56 10 80 	movl   $0x801056df,0x14(%eax)
...
8010363a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010363d:	e8 fe 0d 00 00       	call   80104440 <memset>
...
801037d3:	e8 d8 35 00 00       	call   80106db0 <setupkvm>
...
801037f1:	e8 ca 32 00 00       	call   80106ac0 <inituvm>
  p->sz = PGSIZE;
...
801038de:	e8 1d 33 00 00       	call   80106c00 <allocuvm>
...
801038f0:	e8 bb 30 00 00       	call   801069b0 <switchuvm>
  return 0;
...
80103914:	e8 e7 33 00 00       	call   80106d00 <deallocuvm>
...
80103968:	e8 13 35 00 00       	call   80106e80 <copyuvm>
...
80103aae:	81 c3 88 00 00 00    	add    $0x88,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103ab4:	e8 f7 2e 00 00       	call   801069b0 <switchuvm>
      p->state = RUNNING;
...
80103ac6:	e8 d0 0b 00 00       	call   8010469b <swtch>
      switchkvm();
80103acb:	e8 c0 2e 00 00       	call   80106990 <switchkvm>
...
80103e8c:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103e8f:	e8 4c e4 ff ff       	call   801022e0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80103e94:	5a                   	pop    %edx
...
80103e98:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e9f:	e8 8c 2e 00 00       	call   80106d30 <freevm>
        p->pid = 0;
...
8010400b:	68 df 79 10 80       	push   $0x801079df
...
801040ba:	68 d8 76 10 80       	push   $0x801076d8
...
801042f5:	68 fa 76 10 80       	push   $0x801076fa
...
80104302:	68 e3 76 10 80       	push   $0x801076e3
...
801043e3:	68 01 77 10 80       	push   $0x80107701
...
8010442c:	68 09 77 10 80       	push   $0x80107709
...
//  char* syscall_name[21] = {"fork", "exit", "wait", "pipe", "read", "kill", "exec", "fstat", "chdir",
...
80104855:	83 fa 16             	cmp    $0x16,%edx
80104858:	77 1e                	ja     80104878 <syscall+0x38>
8010485a:	8b 14 85 40 77 10 80 	mov    -0x7fef88c0(,%eax,4),%edx
...
80104880:	68 11 77 10 80       	push   $0x80107711
...
801049e4:	68 bc 77 10 80       	push   $0x801077bc
...
801049fc:	68 bb 77 10 80       	push   $0x801077bb
...
80104a11:	68 af 77 10 80       	push   $0x801077af
...
80104a1e:	68 be 77 10 80       	push   $0x801077be
...
80104a2b:	68 a0 77 10 80       	push   $0x801077a0
...
80104e3d:	58                   	pop    %eax
80104e3e:	5a                   	pop    %edx
80104e3f:	68 bc 77 10 80       	push   $0x801077bc
...
80104e58:	68 bb 77 10 80       	push   $0x801077bb
...
80104fad:	68 e0 77 10 80       	push   $0x801077e0
...
80104fba:	68 f2 77 10 80       	push   $0x801077f2
...
80104fc7:	68 ce 77 10 80       	push   $0x801077ce
...
80105527:	78 1f                	js     80105548 <sys_sbrk+0x38>
    return -1;
  addr = myproc()->sz;
80105529:	e8 62 e2 ff ff       	call   80103790 <myproc>
8010552e:	8b 18                	mov    (%eax),%ebx
  myproc()->sz += n;
80105530:	e8 5b e2 ff ff       	call   80103790 <myproc>
80105535:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105538:	01 10                	add    %edx,(%eax)
//  if(growproc(n) < 0)
//    return -1;
  return addr;
8010553a:	89 d8                	mov    %ebx,%eax
}
8010553c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010553f:	c9                   	leave  
80105540:	c3                   	ret    
...
8010554d:	eb ed                	jmp    8010553c <sys_sbrk+0x2c>
8010554f:	90                   	nop
...
80105570:	68 60 4f 11 80       	push   $0x80114f60
...
8010557d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105580:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
...
80105593:	68 60 4f 11 80       	push   $0x80114f60
80105598:	68 a0 57 11 80       	push   $0x801157a0
8010559d:	e8 9e e7 ff ff       	call   80103d40 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801055a2:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
801055af:	73 2f                	jae    801055e0 <sys_sleep+0x90>
    if(myproc()->killed){
801055b1:	e8 da e1 ff ff       	call   80103790 <myproc>
...
801055c0:	68 60 4f 11 80       	push   $0x80114f60
801055c5:	e8 26 ee ff ff       	call   801043f0 <release>
      return -1;
...
801055e3:	68 60 4f 11 80       	push   $0x80114f60
801055e8:	e8 03 ee ff ff       	call   801043f0 <release>
  return 0;
...
80105604:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105607:	68 60 4f 11 80       	push   $0x80114f60
8010560c:	e8 2f ed ff ff       	call   80104340 <acquire>
  xticks = ticks;
80105611:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
80105617:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
8010561e:	e8 cd ed ff ff       	call   801043f0 <release>
  return xticks;
}
...
80105633:	83 ec 1c             	sub    $0x1c,%esp
	struct rtcdate *r;
	if(argptr(0,(void*)&r, sizeof(*r))<0) return -1;
80105636:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105639:	6a 18                	push   $0x18
8010563b:	50                   	push   %eax
8010563c:	6a 00                	push   $0x0
8010563e:	e8 5d f1 ff ff       	call   801047a0 <argptr>
80105643:	83 c4 10             	add    $0x10,%esp
80105646:	85 c0                	test   %eax,%eax
80105648:	78 16                	js     80105660 <sys_date+0x30>
	cmostime(r);
8010564a:	83 ec 0c             	sub    $0xc,%esp
8010564d:	ff 75 f4             	pushl  -0xc(%ebp)
80105650:	e8 7b d1 ff ff       	call   801027d0 <cmostime>
	return 0;
...
80105686:	78 38                	js     801056c0 <sys_alarm+0x50>
		return -1;
...
80105693:	e8 08 f1 ff ff       	call   801047a0 <argptr>
80105698:	83 c4 10             	add    $0x10,%esp
8010569b:	85 c0                	test   %eax,%eax
8010569d:	78 21                	js     801056c0 <sys_alarm+0x50>
		return -1;
	myproc()->alarmticks = ticks;
8010569f:	e8 ec e0 ff ff       	call   80103790 <myproc>
801056a4:	8b 55 f0             	mov    -0x10(%ebp),%edx
801056a7:	89 50 7c             	mov    %edx,0x7c(%eax)
	myproc()->alarmhandler = handler;
801056aa:	e8 e1 e0 ff ff       	call   80103790 <myproc>
801056af:	8b 55 f4             	mov    -0xc(%ebp),%edx
801056b2:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
	return 0;
...
801056c8:	06                   	push   %es
  pushl %fs
801056c9:	0f a0                	push   %fs
  pushl %gs
801056cb:	0f a8                	push   %gs
  pushal
801056cd:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801056ce:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056d2:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056d4:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801056d6:	54                   	push   %esp
  call trap
801056d7:	e8 e4 00 00 00       	call   801057c0 <trap>
  addl $4, %esp
801056dc:	83 c4 04             	add    $0x4,%esp
...
801056df:	61                   	popa   
  popl %gs
801056e0:	0f a9                	pop    %gs
  popl %fs
801056e2:	0f a1                	pop    %fs
  popl %es
801056e4:	07                   	pop    %es
  popl %ds
801056e5:	1f                   	pop    %ds
...
80105704:	c6 04 c5 a4 4f 11 80 	movb   $0x0,-0x7feeb05c(,%eax,8)
8010570b:	00 
8010570c:	66 89 0c c5 a2 4f 11 	mov    %cx,-0x7feeb05e(,%eax,8)
80105713:	80 
80105714:	c6 04 c5 a5 4f 11 80 	movb   $0x8e,-0x7feeb05b(,%eax,8)
8010571b:	8e 
8010571c:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
80105723:	80 
80105724:	c1 ea 10             	shr    $0x10,%edx
80105727:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
8010572e:	80 
void
tvinit(void)
{
...
80105749:	68 01 78 10 80       	push   $0x80107801
8010574e:	68 60 4f 11 80       	push   $0x80114f60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105753:	66 89 15 a2 51 11 80 	mov    %dx,0x801151a2
8010575a:	c6 05 a4 51 11 80 00 	movb   $0x0,0x801151a4
80105761:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
80105767:	c1 e8 10             	shr    $0x10,%eax
8010576a:	c6 05 a5 51 11 80 ef 	movb   $0xef,0x801151a5
80105771:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6

  initlock(&tickslock, "time");
80105777:	e8 64 ea ff ff       	call   801041e0 <initlock>
}
...
8010579b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010579f:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
...
801057e0:	ff 24 85 a8 78 10 80 	jmp    *-0x7fef8758(,%eax,4)
...
801057f0:	e8 9b df ff ff       	call   80103790 <myproc>
801057f5:	85 c0                	test   %eax,%eax
801057f7:	0f 84 b1 02 00 00    	je     80105aae <trap+0x2ee>
801057fd:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105801:	0f 84 a7 02 00 00    	je     80105aae <trap+0x2ee>
...
80105807:	83 7f 30 0e          	cmpl   $0xe,0x30(%edi)
8010580b:	0f 84 f7 01 00 00    	je     80105a08 <trap+0x248>
...
80105814:	8b 57 38             	mov    0x38(%edi),%edx
80105817:	89 4d d8             	mov    %ecx,-0x28(%ebp)
8010581a:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010581d:	e8 4e df ff ff       	call   80103770 <cpuid>
80105822:	8b 77 34             	mov    0x34(%edi),%esi
80105825:	8b 5f 30             	mov    0x30(%edi),%ebx
80105828:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010582b:	e8 60 df ff ff       	call   80103790 <myproc>
80105830:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105833:	e8 58 df ff ff       	call   80103790 <myproc>
		uint a = PGROUNDDOWN(rcr2());
		mappages(myproc()->pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U);
		break;	
	}
    ...
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105838:	8b 4d d8             	mov    -0x28(%ebp),%ecx
8010583b:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010583e:	51                   	push   %ecx
...
80105840:	8b 55 e0             	mov    -0x20(%ebp),%edx
    ...
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105843:	ff 75 e4             	pushl  -0x1c(%ebp)
80105846:	56                   	push   %esi
80105847:	53                   	push   %ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105848:	83 c2 6c             	add    $0x6c,%edx
		uint a = PGROUNDDOWN(rcr2());
		mappages(myproc()->pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U);
		break;	
	}
    ...
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010584b:	52                   	push   %edx
8010584c:	ff 70 10             	pushl  0x10(%eax)
8010584f:	68 64 78 10 80       	push   $0x80107864
...
8010585c:	e8 2f df ff ff       	call   80103790 <myproc>
...
80105870:	e8 1b df ff ff       	call   80103790 <myproc>
80105875:	85 c0                	test   %eax,%eax
80105877:	74 0c                	je     80105885 <trap+0xc5>
80105879:	e8 12 df ff ff       	call   80103790 <myproc>
8010587e:	8b 50 24             	mov    0x24(%eax),%edx
80105881:	85 d2                	test   %edx,%edx
80105883:	75 4b                	jne    801058d0 <trap+0x110>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105885:	e8 06 df ff ff       	call   80103790 <myproc>
8010588a:	85 c0                	test   %eax,%eax
8010588c:	74 0b                	je     80105899 <trap+0xd9>
8010588e:	e8 fd de ff ff       	call   80103790 <myproc>
80105893:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105897:	74 4f                	je     801058e8 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105899:	e8 f2 de ff ff       	call   80103790 <myproc>
8010589e:	85 c0                	test   %eax,%eax
801058a0:	74 1d                	je     801058bf <trap+0xff>
801058a2:	e8 e9 de ff ff       	call   80103790 <myproc>
801058a7:	8b 40 24             	mov    0x24(%eax),%eax
801058aa:	85 c0                	test   %eax,%eax
801058ac:	74 11                	je     801058bf <trap+0xff>
801058ae:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801058b2:	83 e0 03             	and    $0x3,%eax
801058b5:	66 83 f8 03          	cmp    $0x3,%ax
801058b9:	0f 84 fa 00 00 00    	je     801059b9 <trap+0x1f9>
    exit();
}
...
801058db:	75 a8                	jne    80105885 <trap+0xc5>
    exit();
801058dd:	e8 de e2 ff ff       	call   80103bc0 <exit>
801058e2:	eb a1                	jmp    80105885 <trap+0xc5>
...
801058ec:	75 ab                	jne    80105899 <trap+0xd9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
801058ee:	e8 fd e3 ff ff       	call   80103cf0 <yield>
801058f3:	eb a4                	jmp    80105899 <trap+0xd9>
801058f5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801058f8:	e8 73 de ff ff       	call   80103770 <cpuid>
801058fd:	85 c0                	test   %eax,%eax
801058ff:	0f 84 cb 00 00 00    	je     801059d0 <trap+0x210>
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    }
...
80105905:	e8 86 de ff ff       	call   80103790 <myproc>
8010590a:	85 c0                	test   %eax,%eax
8010590c:	74 11                	je     8010591f <trap+0x15f>
8010590e:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105912:	83 e0 03             	and    $0x3,%eax
80105915:	66 83 f8 03          	cmp    $0x3,%ax
80105919:	0f 84 39 01 00 00    	je     80105a58 <trap+0x298>
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
8010591f:	e8 ec cd ff ff       	call   80102710 <lapiceoi>
    break;
80105924:	e9 47 ff ff ff       	jmp    80105870 <trap+0xb0>
...
80105935:	e8 d6 cd ff ff       	call   80102710 <lapiceoi>
    break;
8010593a:	e9 31 ff ff ff       	jmp    80105870 <trap+0xb0>
8010593f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105940:	e8 0b 03 00 00       	call   80105c50 <uartintr>
    lapiceoi();
80105945:	e8 c6 cd ff ff       	call   80102710 <lapiceoi>
    break;
8010594a:	e9 21 ff ff ff       	jmp    80105870 <trap+0xb0>
8010594f:	90                   	nop
  case T_IRQ0 + 7:
...
80105957:	e8 14 de ff ff       	call   80103770 <cpuid>
8010595c:	56                   	push   %esi
8010595d:	53                   	push   %ebx
8010595e:	50                   	push   %eax
8010595f:	68 0c 78 10 80       	push   $0x8010780c
80105964:	e8 f7 ac ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105969:	e8 a2 cd ff ff       	call   80102710 <lapiceoi>
    break;
8010596e:	83 c4 10             	add    $0x10,%esp
80105971:	e9 fa fe ff ff       	jmp    80105870 <trap+0xb0>
...
80105979:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105980:	e8 cb c6 ff ff       	call   80102050 <ideintr>
80105985:	eb 98                	jmp    8010591f <trap+0x15f>
...
8010599a:	75 2c                	jne    801059c8 <trap+0x208>
      exit();
    myproc()->tf = tf;
8010599c:	e8 ef dd ff ff       	call   80103790 <myproc>
801059a1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801059a4:	e8 97 ee ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
801059a9:	e8 e2 dd ff ff       	call   80103790 <myproc>
801059ae:	8b 48 24             	mov    0x24(%eax),%ecx
801059b1:	85 c9                	test   %ecx,%ecx
801059b3:	0f 84 06 ff ff ff    	je     801058bf <trap+0xff>
    yield();
...
801059bf:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801059c0:	e9 fb e1 ff ff       	jmp    80103bc0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801059c8:	e8 f3 e1 ff ff       	call   80103bc0 <exit>
801059cd:	eb cd                	jmp    8010599c <trap+0x1dc>
801059cf:	90                   	nop
  }
...
801059d8:	e8 63 e9 ff ff       	call   80104340 <acquire>
      ticks++;
      wakeup(&ticks);
801059dd:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
801059e4:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
801059eb:	e8 10 e5 ff ff       	call   80103f00 <wakeup>
      release(&tickslock);
801059f0:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801059f7:	e8 f4 e9 ff ff       	call   801043f0 <release>
801059fc:	83 c4 10             	add    $0x10,%esp
801059ff:	e9 01 ff ff ff       	jmp    80105905 <trap+0x145>
80105a04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	if(tf->trapno == T_PGFLT){
		char *mem = kalloc();
80105a08:	e8 83 ca ff ff       	call   80102490 <kalloc>
		memset(mem, 0, PGSIZE);
80105a0d:	83 ec 04             	sub    $0x4,%esp
	...
	if(tf->trapno == T_PGFLT){
		char *mem = kalloc();
80105a10:	89 c3                	mov    %eax,%ebx
		memset(mem, 0, PGSIZE);
80105a12:	68 00 10 00 00       	push   $0x1000
80105a17:	6a 00                	push   $0x0
80105a19:	50                   	push   %eax
80105a1a:	e8 21 ea ff ff       	call   80104440 <memset>
80105a1f:	0f 20 d6             	mov    %cr2,%esi
		uint a = PGROUNDDOWN(rcr2());
		mappages(myproc()->pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U);
80105a22:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80105a28:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105a2e:	e8 5d dd ff ff       	call   80103790 <myproc>
80105a33:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80105a3a:	53                   	push   %ebx
80105a3b:	68 00 10 00 00       	push   $0x1000
80105a40:	56                   	push   %esi
80105a41:	ff 70 04             	pushl  0x4(%eax)
80105a44:	e8 b7 0e 00 00       	call   80106900 <mappages>
		break;	
80105a49:	83 c4 20             	add    $0x20,%esp
80105a4c:	e9 1f fe ff ff       	jmp    80105870 <trap+0xb0>
80105a51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	...
	if(myproc() != 0 && (tf->cs & 3) == 3){
		myproc()->tickcount++;
80105a58:	e8 33 dd ff ff       	call   80103790 <myproc>
80105a5d:	83 80 84 00 00 00 01 	addl   $0x1,0x84(%eax)
		if(myproc()->tickcount == myproc()->alarmticks){
80105a64:	e8 27 dd ff ff       	call   80103790 <myproc>
80105a69:	8b 98 84 00 00 00    	mov    0x84(%eax),%ebx
80105a6f:	e8 1c dd ff ff       	call   80103790 <myproc>
80105a74:	3b 58 7c             	cmp    0x7c(%eax),%ebx
80105a77:	0f 85 a2 fe ff ff    	jne    8010591f <trap+0x15f>
			myproc()->tickcount = 0;
80105a7d:	e8 0e dd ff ff       	call   80103790 <myproc>
80105a82:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%eax)
80105a89:	00 00 00 
			tf->esp -= 4;
80105a8c:	8b 47 44             	mov    0x44(%edi),%eax
80105a8f:	8d 50 fc             	lea    -0x4(%eax),%edx
80105a92:	89 57 44             	mov    %edx,0x44(%edi)
			*(int*)(tf->esp) = tf->eip;
80105a95:	8b 57 38             	mov    0x38(%edi),%edx
80105a98:	89 50 fc             	mov    %edx,-0x4(%eax)
			tf->eip = (int)myproc()->alarmhandler;
80105a9b:	e8 f0 dc ff ff       	call   80103790 <myproc>
80105aa0:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80105aa6:	89 47 38             	mov    %eax,0x38(%edi)
80105aa9:	e9 71 fe ff ff       	jmp    8010591f <trap+0x15f>
80105aae:	0f 20 d6             	mov    %cr2,%esi
  ...
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ab1:	8b 5f 38             	mov    0x38(%edi),%ebx
80105ab4:	e8 b7 dc ff ff       	call   80103770 <cpuid>
80105ab9:	83 ec 0c             	sub    $0xc,%esp
80105abc:	56                   	push   %esi
80105abd:	53                   	push   %ebx
80105abe:	50                   	push   %eax
80105abf:	ff 77 30             	pushl  0x30(%edi)
80105ac2:	68 30 78 10 80       	push   $0x80107830
80105ac7:	e8 94 ab ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105acc:	83 c4 14             	add    $0x14,%esp
80105acf:	68 06 78 10 80       	push   $0x80107806
80105ad4:	e8 97 a8 ff ff       	call   80100370 <panic>
...
80105bcf:	bb 28 79 10 80       	mov    $0x80107928,%ebx
...
uartputc(int c)
{
  ...
  if(!uart)
80105bfa:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
80105c20:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
    uartputc(*p);
}
...
80105c67:	6a 00                	push   $0x0
  jmp alltraps
80105c69:	e9 59 fa ff ff       	jmp    801056c7 <alltraps>
...
80105c70:	6a 01                	push   $0x1
  jmp alltraps
80105c72:	e9 50 fa ff ff       	jmp    801056c7 <alltraps>
...
80105c79:	6a 02                	push   $0x2
  jmp alltraps
80105c7b:	e9 47 fa ff ff       	jmp    801056c7 <alltraps>
...
80105c82:	6a 03                	push   $0x3
  jmp alltraps
80105c84:	e9 3e fa ff ff       	jmp    801056c7 <alltraps>
...
80105c8b:	6a 04                	push   $0x4
  jmp alltraps
80105c8d:	e9 35 fa ff ff       	jmp    801056c7 <alltraps>
...
80105c94:	6a 05                	push   $0x5
  jmp alltraps
80105c96:	e9 2c fa ff ff       	jmp    801056c7 <alltraps>
...
80105c9d:	6a 06                	push   $0x6
  jmp alltraps
80105c9f:	e9 23 fa ff ff       	jmp    801056c7 <alltraps>
...
80105ca6:	6a 07                	push   $0x7
  jmp alltraps
80105ca8:	e9 1a fa ff ff       	jmp    801056c7 <alltraps>
...
80105cad:	6a 08                	push   $0x8
  jmp alltraps
80105caf:	e9 13 fa ff ff       	jmp    801056c7 <alltraps>
...
80105cb6:	6a 09                	push   $0x9
  jmp alltraps
80105cb8:	e9 0a fa ff ff       	jmp    801056c7 <alltraps>
...
80105cbd:	6a 0a                	push   $0xa
  jmp alltraps
80105cbf:	e9 03 fa ff ff       	jmp    801056c7 <alltraps>
...
80105cc4:	6a 0b                	push   $0xb
  jmp alltraps
80105cc6:	e9 fc f9 ff ff       	jmp    801056c7 <alltraps>
...
80105ccb:	6a 0c                	push   $0xc
  jmp alltraps
80105ccd:	e9 f5 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105cd2:	6a 0d                	push   $0xd
  jmp alltraps
80105cd4:	e9 ee f9 ff ff       	jmp    801056c7 <alltraps>
...
80105cd9:	6a 0e                	push   $0xe
  jmp alltraps
80105cdb:	e9 e7 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105ce2:	6a 0f                	push   $0xf
  jmp alltraps
80105ce4:	e9 de f9 ff ff       	jmp    801056c7 <alltraps>
...
80105ceb:	6a 10                	push   $0x10
  jmp alltraps
80105ced:	e9 d5 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105cf2:	6a 11                	push   $0x11
  jmp alltraps
80105cf4:	e9 ce f9 ff ff       	jmp    801056c7 <alltraps>
...
80105cfb:	6a 12                	push   $0x12
  jmp alltraps
80105cfd:	e9 c5 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d04:	6a 13                	push   $0x13
  jmp alltraps
80105d06:	e9 bc f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d0d:	6a 14                	push   $0x14
  jmp alltraps
80105d0f:	e9 b3 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d16:	6a 15                	push   $0x15
  jmp alltraps
80105d18:	e9 aa f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d1f:	6a 16                	push   $0x16
  jmp alltraps
80105d21:	e9 a1 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d28:	6a 17                	push   $0x17
  jmp alltraps
80105d2a:	e9 98 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d31:	6a 18                	push   $0x18
  jmp alltraps
80105d33:	e9 8f f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d3a:	6a 19                	push   $0x19
  jmp alltraps
80105d3c:	e9 86 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d43:	6a 1a                	push   $0x1a
  jmp alltraps
80105d45:	e9 7d f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d4c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d4e:	e9 74 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d55:	6a 1c                	push   $0x1c
  jmp alltraps
80105d57:	e9 6b f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d5e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d60:	e9 62 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d67:	6a 1e                	push   $0x1e
  jmp alltraps
80105d69:	e9 59 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d70:	6a 1f                	push   $0x1f
  jmp alltraps
80105d72:	e9 50 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d79:	6a 20                	push   $0x20
  jmp alltraps
80105d7b:	e9 47 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d82:	6a 21                	push   $0x21
  jmp alltraps
80105d84:	e9 3e f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d8b:	6a 22                	push   $0x22
  jmp alltraps
80105d8d:	e9 35 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d94:	6a 23                	push   $0x23
  jmp alltraps
80105d96:	e9 2c f9 ff ff       	jmp    801056c7 <alltraps>
...
80105d9d:	6a 24                	push   $0x24
  jmp alltraps
80105d9f:	e9 23 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105da6:	6a 25                	push   $0x25
  jmp alltraps
80105da8:	e9 1a f9 ff ff       	jmp    801056c7 <alltraps>
...
80105daf:	6a 26                	push   $0x26
  jmp alltraps
80105db1:	e9 11 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105db8:	6a 27                	push   $0x27
  jmp alltraps
80105dba:	e9 08 f9 ff ff       	jmp    801056c7 <alltraps>
...
80105dc1:	6a 28                	push   $0x28
  jmp alltraps
80105dc3:	e9 ff f8 ff ff       	jmp    801056c7 <alltraps>
...
80105dca:	6a 29                	push   $0x29
  jmp alltraps
80105dcc:	e9 f6 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105dd3:	6a 2a                	push   $0x2a
  jmp alltraps
80105dd5:	e9 ed f8 ff ff       	jmp    801056c7 <alltraps>
...
80105ddc:	6a 2b                	push   $0x2b
  jmp alltraps
80105dde:	e9 e4 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105de5:	6a 2c                	push   $0x2c
  jmp alltraps
80105de7:	e9 db f8 ff ff       	jmp    801056c7 <alltraps>
...
80105dee:	6a 2d                	push   $0x2d
  jmp alltraps
80105df0:	e9 d2 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105df7:	6a 2e                	push   $0x2e
  jmp alltraps
80105df9:	e9 c9 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e00:	6a 2f                	push   $0x2f
  jmp alltraps
80105e02:	e9 c0 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e09:	6a 30                	push   $0x30
  jmp alltraps
80105e0b:	e9 b7 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e12:	6a 31                	push   $0x31
  jmp alltraps
80105e14:	e9 ae f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e1b:	6a 32                	push   $0x32
  jmp alltraps
80105e1d:	e9 a5 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e24:	6a 33                	push   $0x33
  jmp alltraps
80105e26:	e9 9c f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e2d:	6a 34                	push   $0x34
  jmp alltraps
80105e2f:	e9 93 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e36:	6a 35                	push   $0x35
  jmp alltraps
80105e38:	e9 8a f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e3f:	6a 36                	push   $0x36
  jmp alltraps
80105e41:	e9 81 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e48:	6a 37                	push   $0x37
  jmp alltraps
80105e4a:	e9 78 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e51:	6a 38                	push   $0x38
  jmp alltraps
80105e53:	e9 6f f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e5a:	6a 39                	push   $0x39
  jmp alltraps
80105e5c:	e9 66 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e63:	6a 3a                	push   $0x3a
  jmp alltraps
80105e65:	e9 5d f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e6c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e6e:	e9 54 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e75:	6a 3c                	push   $0x3c
  jmp alltraps
80105e77:	e9 4b f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e7e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e80:	e9 42 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e87:	6a 3e                	push   $0x3e
  jmp alltraps
80105e89:	e9 39 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e90:	6a 3f                	push   $0x3f
  jmp alltraps
80105e92:	e9 30 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105e99:	6a 40                	push   $0x40
  jmp alltraps
80105e9b:	e9 27 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105ea2:	6a 41                	push   $0x41
  jmp alltraps
80105ea4:	e9 1e f8 ff ff       	jmp    801056c7 <alltraps>
...
80105eab:	6a 42                	push   $0x42
  jmp alltraps
80105ead:	e9 15 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105eb4:	6a 43                	push   $0x43
  jmp alltraps
80105eb6:	e9 0c f8 ff ff       	jmp    801056c7 <alltraps>
...
80105ebd:	6a 44                	push   $0x44
  jmp alltraps
80105ebf:	e9 03 f8 ff ff       	jmp    801056c7 <alltraps>
...
80105ec6:	6a 45                	push   $0x45
  jmp alltraps
80105ec8:	e9 fa f7 ff ff       	jmp    801056c7 <alltraps>
...
80105ecf:	6a 46                	push   $0x46
  jmp alltraps
80105ed1:	e9 f1 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105ed8:	6a 47                	push   $0x47
  jmp alltraps
80105eda:	e9 e8 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105ee1:	6a 48                	push   $0x48
  jmp alltraps
80105ee3:	e9 df f7 ff ff       	jmp    801056c7 <alltraps>
...
80105eea:	6a 49                	push   $0x49
  jmp alltraps
80105eec:	e9 d6 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105ef3:	6a 4a                	push   $0x4a
  jmp alltraps
80105ef5:	e9 cd f7 ff ff       	jmp    801056c7 <alltraps>
...
80105efc:	6a 4b                	push   $0x4b
  jmp alltraps
80105efe:	e9 c4 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f05:	6a 4c                	push   $0x4c
  jmp alltraps
80105f07:	e9 bb f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f0e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f10:	e9 b2 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f17:	6a 4e                	push   $0x4e
  jmp alltraps
80105f19:	e9 a9 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f20:	6a 4f                	push   $0x4f
  jmp alltraps
80105f22:	e9 a0 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f29:	6a 50                	push   $0x50
  jmp alltraps
80105f2b:	e9 97 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f32:	6a 51                	push   $0x51
  jmp alltraps
80105f34:	e9 8e f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f3b:	6a 52                	push   $0x52
  jmp alltraps
80105f3d:	e9 85 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f44:	6a 53                	push   $0x53
  jmp alltraps
80105f46:	e9 7c f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f4d:	6a 54                	push   $0x54
  jmp alltraps
80105f4f:	e9 73 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f56:	6a 55                	push   $0x55
  jmp alltraps
80105f58:	e9 6a f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f5f:	6a 56                	push   $0x56
  jmp alltraps
80105f61:	e9 61 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f68:	6a 57                	push   $0x57
  jmp alltraps
80105f6a:	e9 58 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f71:	6a 58                	push   $0x58
  jmp alltraps
80105f73:	e9 4f f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f7a:	6a 59                	push   $0x59
  jmp alltraps
80105f7c:	e9 46 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f83:	6a 5a                	push   $0x5a
  jmp alltraps
80105f85:	e9 3d f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f8c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f8e:	e9 34 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f95:	6a 5c                	push   $0x5c
  jmp alltraps
80105f97:	e9 2b f7 ff ff       	jmp    801056c7 <alltraps>
...
80105f9e:	6a 5d                	push   $0x5d
  jmp alltraps
80105fa0:	e9 22 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105fa7:	6a 5e                	push   $0x5e
  jmp alltraps
80105fa9:	e9 19 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105fb0:	6a 5f                	push   $0x5f
  jmp alltraps
80105fb2:	e9 10 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105fb9:	6a 60                	push   $0x60
  jmp alltraps
80105fbb:	e9 07 f7 ff ff       	jmp    801056c7 <alltraps>
...
80105fc2:	6a 61                	push   $0x61
  jmp alltraps
80105fc4:	e9 fe f6 ff ff       	jmp    801056c7 <alltraps>
...
80105fcb:	6a 62                	push   $0x62
  jmp alltraps
80105fcd:	e9 f5 f6 ff ff       	jmp    801056c7 <alltraps>
...
80105fd4:	6a 63                	push   $0x63
  jmp alltraps
80105fd6:	e9 ec f6 ff ff       	jmp    801056c7 <alltraps>
...
80105fdd:	6a 64                	push   $0x64
  jmp alltraps
80105fdf:	e9 e3 f6 ff ff       	jmp    801056c7 <alltraps>
...
80105fe6:	6a 65                	push   $0x65
  jmp alltraps
80105fe8:	e9 da f6 ff ff       	jmp    801056c7 <alltraps>
...
80105fef:	6a 66                	push   $0x66
  jmp alltraps
80105ff1:	e9 d1 f6 ff ff       	jmp    801056c7 <alltraps>
...
80105ff8:	6a 67                	push   $0x67
  jmp alltraps
80105ffa:	e9 c8 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106001:	6a 68                	push   $0x68
  jmp alltraps
80106003:	e9 bf f6 ff ff       	jmp    801056c7 <alltraps>
...
8010600a:	6a 69                	push   $0x69
  jmp alltraps
8010600c:	e9 b6 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106013:	6a 6a                	push   $0x6a
  jmp alltraps
80106015:	e9 ad f6 ff ff       	jmp    801056c7 <alltraps>
...
8010601c:	6a 6b                	push   $0x6b
  jmp alltraps
8010601e:	e9 a4 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106025:	6a 6c                	push   $0x6c
  jmp alltraps
80106027:	e9 9b f6 ff ff       	jmp    801056c7 <alltraps>
...
8010602e:	6a 6d                	push   $0x6d
  jmp alltraps
80106030:	e9 92 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106037:	6a 6e                	push   $0x6e
  jmp alltraps
80106039:	e9 89 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106040:	6a 6f                	push   $0x6f
  jmp alltraps
80106042:	e9 80 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106049:	6a 70                	push   $0x70
  jmp alltraps
8010604b:	e9 77 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106052:	6a 71                	push   $0x71
  jmp alltraps
80106054:	e9 6e f6 ff ff       	jmp    801056c7 <alltraps>
...
8010605b:	6a 72                	push   $0x72
  jmp alltraps
8010605d:	e9 65 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106064:	6a 73                	push   $0x73
  jmp alltraps
80106066:	e9 5c f6 ff ff       	jmp    801056c7 <alltraps>
...
8010606d:	6a 74                	push   $0x74
  jmp alltraps
8010606f:	e9 53 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106076:	6a 75                	push   $0x75
  jmp alltraps
80106078:	e9 4a f6 ff ff       	jmp    801056c7 <alltraps>
...
8010607f:	6a 76                	push   $0x76
  jmp alltraps
80106081:	e9 41 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106088:	6a 77                	push   $0x77
  jmp alltraps
8010608a:	e9 38 f6 ff ff       	jmp    801056c7 <alltraps>
...
80106091:	6a 78                	push   $0x78
  jmp alltraps
80106093:	e9 2f f6 ff ff       	jmp    801056c7 <alltraps>
...
8010609a:	6a 79                	push   $0x79
  jmp alltraps
8010609c:	e9 26 f6 ff ff       	jmp    801056c7 <alltraps>
...
801060a3:	6a 7a                	push   $0x7a
  jmp alltraps
801060a5:	e9 1d f6 ff ff       	jmp    801056c7 <alltraps>
...
801060ac:	6a 7b                	push   $0x7b
  jmp alltraps
801060ae:	e9 14 f6 ff ff       	jmp    801056c7 <alltraps>
...
801060b5:	6a 7c                	push   $0x7c
  jmp alltraps
801060b7:	e9 0b f6 ff ff       	jmp    801056c7 <alltraps>
...
801060be:	6a 7d                	push   $0x7d
  jmp alltraps
801060c0:	e9 02 f6 ff ff       	jmp    801056c7 <alltraps>
...
801060c7:	6a 7e                	push   $0x7e
  jmp alltraps
801060c9:	e9 f9 f5 ff ff       	jmp    801056c7 <alltraps>
...
801060d0:	6a 7f                	push   $0x7f
  jmp alltraps
801060d2:	e9 f0 f5 ff ff       	jmp    801056c7 <alltraps>
...
801060d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801060de:	e9 e4 f5 ff ff       	jmp    801056c7 <alltraps>
...
801060e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801060ea:	e9 d8 f5 ff ff       	jmp    801056c7 <alltraps>
...
801060f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801060f6:	e9 cc f5 ff ff       	jmp    801056c7 <alltraps>
...
801060fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106102:	e9 c0 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106109:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010610e:	e9 b4 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106115:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010611a:	e9 a8 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106121:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106126:	e9 9c f5 ff ff       	jmp    801056c7 <alltraps>
...
8010612d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106132:	e9 90 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106139:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010613e:	e9 84 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106145:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010614a:	e9 78 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106151:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106156:	e9 6c f5 ff ff       	jmp    801056c7 <alltraps>
...
8010615d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106162:	e9 60 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106169:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010616e:	e9 54 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106175:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010617a:	e9 48 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106181:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106186:	e9 3c f5 ff ff       	jmp    801056c7 <alltraps>
...
8010618d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106192:	e9 30 f5 ff ff       	jmp    801056c7 <alltraps>
...
80106199:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010619e:	e9 24 f5 ff ff       	jmp    801056c7 <alltraps>
...
801061a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801061aa:	e9 18 f5 ff ff       	jmp    801056c7 <alltraps>
...
801061b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801061b6:	e9 0c f5 ff ff       	jmp    801056c7 <alltraps>
...
801061bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801061c2:	e9 00 f5 ff ff       	jmp    801056c7 <alltraps>
...
801061c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801061ce:	e9 f4 f4 ff ff       	jmp    801056c7 <alltraps>
...
801061d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801061da:	e9 e8 f4 ff ff       	jmp    801056c7 <alltraps>
...
801061e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801061e6:	e9 dc f4 ff ff       	jmp    801056c7 <alltraps>
...
801061ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801061f2:	e9 d0 f4 ff ff       	jmp    801056c7 <alltraps>
...
801061f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801061fe:	e9 c4 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106205:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010620a:	e9 b8 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106211:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106216:	e9 ac f4 ff ff       	jmp    801056c7 <alltraps>
...
8010621d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106222:	e9 a0 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106229:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010622e:	e9 94 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106235:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010623a:	e9 88 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106241:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106246:	e9 7c f4 ff ff       	jmp    801056c7 <alltraps>
...
8010624d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106252:	e9 70 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106259:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010625e:	e9 64 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106265:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010626a:	e9 58 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106271:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106276:	e9 4c f4 ff ff       	jmp    801056c7 <alltraps>
...
8010627d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106282:	e9 40 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106289:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010628e:	e9 34 f4 ff ff       	jmp    801056c7 <alltraps>
...
80106295:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010629a:	e9 28 f4 ff ff       	jmp    801056c7 <alltraps>
...
801062a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801062a6:	e9 1c f4 ff ff       	jmp    801056c7 <alltraps>
...
801062ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801062b2:	e9 10 f4 ff ff       	jmp    801056c7 <alltraps>
...
801062b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801062be:	e9 04 f4 ff ff       	jmp    801056c7 <alltraps>
...
801062c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801062ca:	e9 f8 f3 ff ff       	jmp    801056c7 <alltraps>
...
801062d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801062d6:	e9 ec f3 ff ff       	jmp    801056c7 <alltraps>
...
801062dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801062e2:	e9 e0 f3 ff ff       	jmp    801056c7 <alltraps>
...
801062e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801062ee:	e9 d4 f3 ff ff       	jmp    801056c7 <alltraps>
...
801062f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801062fa:	e9 c8 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106301:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106306:	e9 bc f3 ff ff       	jmp    801056c7 <alltraps>
...
8010630d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106312:	e9 b0 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106319:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010631e:	e9 a4 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106325:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010632a:	e9 98 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106331:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106336:	e9 8c f3 ff ff       	jmp    801056c7 <alltraps>
...
8010633d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106342:	e9 80 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106349:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010634e:	e9 74 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106355:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010635a:	e9 68 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106361:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106366:	e9 5c f3 ff ff       	jmp    801056c7 <alltraps>
...
8010636d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106372:	e9 50 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106379:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010637e:	e9 44 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106385:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010638a:	e9 38 f3 ff ff       	jmp    801056c7 <alltraps>
...
80106391:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106396:	e9 2c f3 ff ff       	jmp    801056c7 <alltraps>
...
8010639d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801063a2:	e9 20 f3 ff ff       	jmp    801056c7 <alltraps>
...
801063a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801063ae:	e9 14 f3 ff ff       	jmp    801056c7 <alltraps>
...
801063b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801063ba:	e9 08 f3 ff ff       	jmp    801056c7 <alltraps>
...
801063c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801063c6:	e9 fc f2 ff ff       	jmp    801056c7 <alltraps>
...
801063cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801063d2:	e9 f0 f2 ff ff       	jmp    801056c7 <alltraps>
...
801063d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801063de:	e9 e4 f2 ff ff       	jmp    801056c7 <alltraps>
...
801063e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801063ea:	e9 d8 f2 ff ff       	jmp    801056c7 <alltraps>
...
801063f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801063f6:	e9 cc f2 ff ff       	jmp    801056c7 <alltraps>
...
801063fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106402:	e9 c0 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106409:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010640e:	e9 b4 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106415:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010641a:	e9 a8 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106421:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106426:	e9 9c f2 ff ff       	jmp    801056c7 <alltraps>
...
8010642d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106432:	e9 90 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106439:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010643e:	e9 84 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106445:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010644a:	e9 78 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106451:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106456:	e9 6c f2 ff ff       	jmp    801056c7 <alltraps>
...
8010645d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106462:	e9 60 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106469:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010646e:	e9 54 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106475:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010647a:	e9 48 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106481:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106486:	e9 3c f2 ff ff       	jmp    801056c7 <alltraps>
...
8010648d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106492:	e9 30 f2 ff ff       	jmp    801056c7 <alltraps>
...
80106499:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010649e:	e9 24 f2 ff ff       	jmp    801056c7 <alltraps>
...
801064a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801064aa:	e9 18 f2 ff ff       	jmp    801056c7 <alltraps>
...
801064b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801064b6:	e9 0c f2 ff ff       	jmp    801056c7 <alltraps>
...
801064bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801064c2:	e9 00 f2 ff ff       	jmp    801056c7 <alltraps>
...
801064c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801064ce:	e9 f4 f1 ff ff       	jmp    801056c7 <alltraps>
...
801064d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801064da:	e9 e8 f1 ff ff       	jmp    801056c7 <alltraps>
...
801064e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801064e6:	e9 dc f1 ff ff       	jmp    801056c7 <alltraps>
...
801064ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801064f2:	e9 d0 f1 ff ff       	jmp    801056c7 <alltraps>
...
801064f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801064fe:	e9 c4 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106505:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010650a:	e9 b8 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106511:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106516:	e9 ac f1 ff ff       	jmp    801056c7 <alltraps>
...
8010651d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106522:	e9 a0 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106529:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010652e:	e9 94 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106535:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010653a:	e9 88 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106541:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106546:	e9 7c f1 ff ff       	jmp    801056c7 <alltraps>
...
8010654d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106552:	e9 70 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106559:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010655e:	e9 64 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106565:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010656a:	e9 58 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106571:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106576:	e9 4c f1 ff ff       	jmp    801056c7 <alltraps>
...
8010657d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106582:	e9 40 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106589:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010658e:	e9 34 f1 ff ff       	jmp    801056c7 <alltraps>
...
80106595:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010659a:	e9 28 f1 ff ff       	jmp    801056c7 <alltraps>
...
801065a1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801065a6:	e9 1c f1 ff ff       	jmp    801056c7 <alltraps>
...
801065ad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801065b2:	e9 10 f1 ff ff       	jmp    801056c7 <alltraps>
...
801065b9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801065be:	e9 04 f1 ff ff       	jmp    801056c7 <alltraps>
...
801065c5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801065ca:	e9 f8 f0 ff ff       	jmp    801056c7 <alltraps>
...
801065d1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801065d6:	e9 ec f0 ff ff       	jmp    801056c7 <alltraps>
...
801065dd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801065e2:	e9 e0 f0 ff ff       	jmp    801056c7 <alltraps>
...
801065e9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801065ee:	e9 d4 f0 ff ff       	jmp    801056c7 <alltraps>
...
801065f5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801065fa:	e9 c8 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106601:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106606:	e9 bc f0 ff ff       	jmp    801056c7 <alltraps>
...
8010660d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106612:	e9 b0 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106619:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010661e:	e9 a4 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106625:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010662a:	e9 98 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106631:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106636:	e9 8c f0 ff ff       	jmp    801056c7 <alltraps>
...
8010663d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106642:	e9 80 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106649:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010664e:	e9 74 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106655:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010665a:	e9 68 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106661:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106666:	e9 5c f0 ff ff       	jmp    801056c7 <alltraps>
...
8010666d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106672:	e9 50 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106679:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010667e:	e9 44 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106685:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010668a:	e9 38 f0 ff ff       	jmp    801056c7 <alltraps>
...
80106691:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106696:	e9 2c f0 ff ff       	jmp    801056c7 <alltraps>
...
8010669d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801066a2:	e9 20 f0 ff ff       	jmp    801056c7 <alltraps>
...
801066a9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066ae:	e9 14 f0 ff ff       	jmp    801056c7 <alltraps>
...
801066b5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066ba:	e9 08 f0 ff ff       	jmp    801056c7 <alltraps>
...
801066c1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801066c6:	e9 fc ef ff ff       	jmp    801056c7 <alltraps>
...
801066cd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801066d2:	e9 f0 ef ff ff       	jmp    801056c7 <alltraps>
...
8010673a:	e8 01 dd ff ff       	call   80104440 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801067a4:	e8 37 bb ff ff       	call   801022e0 <kfree>
      *pte = 0;
...
801067c5:	e8 16 ff ff ff       	call   801066e0 <walkpgdir>
    if(!pte)
...
801067f2:	68 c6 72 10 80       	push   $0x801072c6
...
80106803:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106806:	e8 65 cf ff ff       	call   80103770 <cpuid>
...
80106818:	66 89 90 f8 27 11 80 	mov    %dx,-0x7feed808(%eax)
8010681f:	66 89 88 fa 27 11 80 	mov    %cx,-0x7feed806(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106826:	ba ff ff ff ff       	mov    $0xffffffff,%edx
8010682b:	31 c9                	xor    %ecx,%ecx
8010682d:	66 89 90 00 28 11 80 	mov    %dx,-0x7feed800(%eax)
...
80106834:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106839:	66 89 88 02 28 11 80 	mov    %cx,-0x7feed7fe(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106840:	31 c9                	xor    %ecx,%ecx
80106842:	66 89 90 08 28 11 80 	mov    %dx,-0x7feed7f8(%eax)
80106849:	66 89 88 0a 28 11 80 	mov    %cx,-0x7feed7f6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106850:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106855:	31 c9                	xor    %ecx,%ecx
80106857:	66 89 90 10 28 11 80 	mov    %dx,-0x7feed7f0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010685e:	c6 80 fc 27 11 80 00 	movb   $0x0,-0x7feed804(%eax)
static inline void
...
8010686a:	c6 80 fd 27 11 80 9a 	movb   $0x9a,-0x7feed803(%eax)
80106871:	c6 80 fe 27 11 80 cf 	movb   $0xcf,-0x7feed802(%eax)
80106878:	c6 80 ff 27 11 80 00 	movb   $0x0,-0x7feed801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010687f:	c6 80 04 28 11 80 00 	movb   $0x0,-0x7feed7fc(%eax)
80106886:	c6 80 05 28 11 80 92 	movb   $0x92,-0x7feed7fb(%eax)
8010688d:	c6 80 06 28 11 80 cf 	movb   $0xcf,-0x7feed7fa(%eax)
80106894:	c6 80 07 28 11 80 00 	movb   $0x0,-0x7feed7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010689b:	c6 80 0c 28 11 80 00 	movb   $0x0,-0x7feed7f4(%eax)
801068a2:	c6 80 0d 28 11 80 fa 	movb   $0xfa,-0x7feed7f3(%eax)
801068a9:	c6 80 0e 28 11 80 cf 	movb   $0xcf,-0x7feed7f2(%eax)
801068b0:	c6 80 0f 28 11 80 00 	movb   $0x0,-0x7feed7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068b7:	66 89 88 12 28 11 80 	mov    %cx,-0x7feed7ee(%eax)
801068be:	c6 80 14 28 11 80 00 	movb   $0x0,-0x7feed7ec(%eax)
801068c5:	c6 80 15 28 11 80 f2 	movb   $0xf2,-0x7feed7eb(%eax)
801068cc:	c6 80 16 28 11 80 cf 	movb   $0xcf,-0x7feed7ea(%eax)
801068d3:	c6 80 17 28 11 80 00 	movb   $0x0,-0x7feed7e9(%eax)
...
80106909:	8b 45 0c             	mov    0xc(%ebp),%eax
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010690c:	8b 55 10             	mov    0x10(%ebp),%edx
8010690f:	8b 7d 14             	mov    0x14(%ebp),%edi
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
  char *a, *last;
  pte_t *pte;
...
80106912:	89 c3                	mov    %eax,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106914:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
  char *a, *last;
  pte_t *pte;
...
80106918:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010691e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106923:	29 df                	sub    %ebx,%edi
80106925:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106928:	8b 45 18             	mov    0x18(%ebp),%eax
8010692b:	83 c8 01             	or     $0x1,%eax
8010692e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106931:	eb 1a                	jmp    8010694d <mappages+0x4d>
80106933:	90                   	nop
80106934:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
80106938:	f6 00 01             	testb  $0x1,(%eax)
8010693b:	75 3d                	jne    8010697a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
8010693d:	0b 75 e0             	or     -0x20(%ebp),%esi
    if(a == last)
80106940:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106943:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106945:	74 29                	je     80106970 <mappages+0x70>
      break;
    a += PGSIZE;
80106947:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  pte_t *pte;
...
80106950:	b9 01 00 00 00       	mov    $0x1,%ecx
80106955:	89 da                	mov    %ebx,%edx
80106957:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
8010695a:	e8 81 fd ff ff       	call   801066e0 <walkpgdir>
8010695f:	85 c0                	test   %eax,%eax
80106961:	75 d5                	jne    80106938 <mappages+0x38>
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
...
8010697d:	68 30 79 10 80       	push   $0x80107930
...
801069d4:	0f 84 c4 00 00 00    	je     80106a9e <switchuvm+0xee>
  ...
  pushcli();
801069da:	e8 81 d8 ff ff       	call   80104260 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069df:	e8 0c cd ff ff       	call   801036f0 <mycpu>
801069e4:	89 c3                	mov    %eax,%ebx
801069e6:	e8 05 cd ff ff       	call   801036f0 <mycpu>
801069eb:	89 c7                	mov    %eax,%edi
801069ed:	e8 fe cc ff ff       	call   801036f0 <mycpu>
801069f2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801069f5:	83 c7 08             	add    $0x8,%edi
801069f8:	e8 f3 cc ff ff       	call   801036f0 <mycpu>
...
80106a39:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106a3e:	e8 ad cc ff ff       	call   801036f0 <mycpu>
80106a43:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106a4a:	e8 a1 cc ff ff       	call   801036f0 <mycpu>
...
80106a66:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a69:	e8 82 cc ff ff       	call   801036f0 <mycpu>
...
80106a8b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106a8c:	e9 0f d8 ff ff       	jmp    801042a0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106a94:	68 36 79 10 80       	push   $0x80107936
...
80106aa1:	68 61 79 10 80       	push   $0x80107961
...
80106aae:	68 4c 79 10 80       	push   $0x8010794c
...
80106ad8:	77 50                	ja     80106b2a <inituvm+0x6a>
80106ada:	89 55 e4             	mov    %edx,-0x1c(%ebp)
...
80106aef:	e8 4c d9 ff ff       	call   80104440 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106af4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106af7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106afd:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106b04:	50                   	push   %eax
80106b05:	68 00 10 00 00       	push   $0x1000
80106b0a:	6a 00                	push   $0x0
80106b0c:	52                   	push   %edx
80106b0d:	e8 ee fd ff ff       	call   80106900 <mappages>
  memmove(mem, init, sz);
80106b12:	89 75 10             	mov    %esi,0x10(%ebp)
80106b15:	89 7d 0c             	mov    %edi,0xc(%ebp)
...
80106b24:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106b25:	e9 c6 d9 ff ff       	jmp    801044f0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106b2d:	68 75 79 10 80       	push   $0x80107975
...
80106bdd:	68 8f 79 10 80       	push   $0x8010798f
...
80106bea:	68 30 7a 10 80       	push   $0x80107a30
...
80106c17:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80106c1a:	0f 82 84 00 00 00    	jb     80106ca4 <allocuvm+0xa4>
    return oldsz;
...
80106c2e:	77 45                	ja     80106c75 <allocuvm+0x75>
...
80106c43:	e8 f8 d7 ff ff       	call   80104440 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106c48:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106c4e:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106c55:	50                   	push   %eax
80106c56:	68 00 10 00 00       	push   $0x1000
80106c5b:	53                   	push   %ebx
80106c5c:	ff 75 08             	pushl  0x8(%ebp)
80106c5f:	e8 9c fc ff ff       	call   80106900 <mappages>
80106c64:	83 c4 20             	add    $0x20,%esp
80106c67:	85 c0                	test   %eax,%eax
80106c69:	78 45                	js     80106cb0 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80106c71:	39 df                	cmp    %ebx,%edi
80106c73:	76 7b                	jbe    80106cf0 <allocuvm+0xf0>
    mem = kalloc();
...
80106c7c:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106c7e:	75 b8                	jne    80106c38 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106c80:	83 ec 0c             	sub    $0xc,%esp
80106c83:	68 ad 79 10 80       	push   $0x801079ad
...
80106c93:	76 49                	jbe    80106cde <allocuvm+0xde>
80106c95:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106c98:	8b 45 08             	mov    0x8(%ebp),%eax
80106c9b:	89 fa                	mov    %edi,%edx
80106c9d:	e8 be fa ff ff       	call   80106760 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106cb3:	68 c5 79 10 80       	push   $0x801079c5
...
80106ccd:	e8 8e fa ff ff       	call   80106760 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106d49:	e8 12 fa ff ff       	call   80106760 <deallocuvm.part.0>
...
80106dd0:	e8 6b d6 ff ff       	call   80104440 <memset>
...
80106ddb:	8b 53 08             	mov    0x8(%ebx),%edx
80106dde:	83 ec 0c             	sub    $0xc,%esp
80106de1:	ff 73 0c             	pushl  0xc(%ebx)
80106de4:	29 c2                	sub    %eax,%edx
80106de6:	50                   	push   %eax
80106de7:	52                   	push   %edx
80106de8:	ff 33                	pushl  (%ebx)
80106dea:	56                   	push   %esi
80106deb:	e8 10 fb ff ff       	call   80106900 <mappages>
80106df0:	83 c4 20             	add    $0x20,%esp
...
80106ea6:	eb 48                	jmp    80106ef0 <copyuvm+0x70>
80106ea8:	90                   	nop
...
80106ec0:	e8 2b d6 ff ff       	call   801044f0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106ec5:	58                   	pop    %eax
80106ec6:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
...
80106ed9:	e8 22 fa ff ff       	call   80106900 <mappages>
80106ede:	83 c4 20             	add    $0x20,%esp
80106ee1:	85 c0                	test   %eax,%eax
80106ee3:	78 6b                	js     80106f50 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
...
80106eeb:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106eee:	76 50                	jbe    80106f40 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106ef0:	8b 45 08             	mov    0x8(%ebp),%eax
80106ef3:	31 c9                	xor    %ecx,%ecx
80106ef5:	89 f2                	mov    %esi,%edx
80106ef7:	e8 e4 f7 ff ff       	call   801066e0 <walkpgdir>
80106efc:	85 c0                	test   %eax,%eax
80106efe:	74 6f                	je     80106f6f <copyuvm+0xef>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106f00:	8b 38                	mov    (%eax),%edi
80106f02:	f7 c7 01 00 00 00    	test   $0x1,%edi
80106f08:	74 58                	je     80106f62 <copyuvm+0xe2>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106f0a:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
80106f0c:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80106f12:	89 7d e4             	mov    %edi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106f15:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106f1b:	e8 70 b5 ff ff       	call   80102490 <kalloc>
80106f20:	85 c0                	test   %eax,%eax
80106f22:	89 c7                	mov    %eax,%edi
80106f24:	75 8a                	jne    80106eb0 <copyuvm+0x30>
    }
  }
  return d;
...
80106f29:	ff 75 e0             	pushl  -0x20(%ebp)
80106f2c:	e8 ff fd ff ff       	call   80106d30 <freevm>
  return 0;
80106f31:	83 c4 10             	add    $0x10,%esp
80106f34:	31 c0                	xor    %eax,%eax
}
...
80106f5c:	eb c8                	jmp    80106f26 <copyuvm+0xa6>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
...
80106f60:	eb d4                	jmp    80106f36 <copyuvm+0xb6>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106f65:	68 16 7a 10 80       	push   $0x80107a16
...
80106f72:	68 fc 79 10 80       	push   $0x801079fc
...
80106fff:	e8 ec d4 ff ff       	call   801044f0 <memmove>
    len -= n;
    buf += n;
