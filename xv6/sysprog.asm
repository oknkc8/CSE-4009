...
_sysprog:     file format elf32-i386
...
int main(){
   ...
   e:	83 ec 1c             	sub    $0x1c,%esp
	char *argv[3];
	argv[0]="echo";
  11:	c7 45 ec 10 07 00 00 	movl   $0x710,-0x14(%ebp)
	argv[1] = "hello!";
  18:	c7 45 f0 15 07 00 00 	movl   $0x715,-0x10(%ebp)
	argv[2] = 0;
	printf(1,"hello world!\n");
  1f:	68 1c 07 00 00       	push   $0x71c
  24:	6a 01                	push   $0x1
...
int main(){
  ...
  3d:	e8 88 02 00 00       	call   2ca <exec>
	exit();
