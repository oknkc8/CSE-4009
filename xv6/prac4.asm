...
int main(){
   ...
   e:	83 ec 14             	sub    $0x14,%esp
	char *argv[2];
	argv[0]="cat";
  11:	c7 45 f0 20 07 00 00 	movl   $0x720,-0x10(%ebp)
	argv[1]=0;
  18:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if(fork()==0){
  1f:	e8 76 02 00 00       	call   29a <fork>
  24:	85 c0                	test   %eax,%eax
  26:	75 30                	jne    58 <main+0x58>
		close(0);
  28:	83 ec 0c             	sub    $0xc,%esp
  2b:	6a 00                	push   $0x0
  2d:	e8 98 02 00 00       	call   2ca <close>
		open("input.txt",0);
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	6a 00                	push   $0x0
  36:	68 24 07 00 00       	push   $0x724
  3b:	e8 a2 02 00 00       	call   2e2 <open>
		exec("cat",argv);
  40:	59                   	pop    %ecx
  41:	58                   	pop    %eax
  42:	8d 45 f0             	lea    -0x10(%ebp),%eax
  45:	50                   	push   %eax
  46:	68 20 07 00 00       	push   $0x720
  4b:	e8 8a 02 00 00       	call   2da <exec>
  ...
  58:	e8 4d 02 00 00       	call   2aa <wait>
  5d:	eb f4                	jmp    53 <main+0x53>
  5f:	90                   	nop
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 2e 07 00 00       	mov    $0x72e,%eax
